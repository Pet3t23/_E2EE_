 ...
 *
 * Si la inicialización de Winsock falla, se muestra un mensaje de error y
 ...
 * @return true si el servidor inició correctamente, false en caso de error.
 */
...
/**
 * @brief Acepta la conexión de un cliente entrante.
...
/**
 * @brief Recibe datos binarios de tamaño fijo desde el socket.
 * @param size Cantidad de bytes a recibir.
 * @return Vector de bytes recibidos o vacío si hay error.
 */
...
/**
 * @brief Envía todos los datos indicados hasta completar el tamaño.
 */
